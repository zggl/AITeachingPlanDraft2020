...
\pagestyle{fancy}
\setcounter{page}{0}
\include{tex/chapter1}   %第一章AI Outline
\include{tex/chapter2}   %第二章知识表示 KR
\include{tex/chapter3}   %第三章推理方法
\include{tex/chapter4}   %第四章搜索策略
\include{tex/chapter5}   %第五章Computational AI
\include{tex/chapter6}   %第六章不确定性推理
\include{tex/chapter7}   %第七章ML
\include{tex/chapter8}   %第八章自然语言理解
\include{tex/chapter9}   %第九章Distributed AI
\include{tex/chapter10}  %第十章  专家系统 ES
\include{tex/chapter11}  %第十一章  计算机视觉 CV
%\include{tex/chapter8}  %说明文档
