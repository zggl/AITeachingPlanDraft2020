...
\pagestyle{fancy}
\setcounter{page}{0}
\include{tex/chapter1}   %AI Outline
\include{tex/chapter2}   %知识表示 KR
\include{tex/chapter3}   %推理方法
\include{tex/chapter4}   %搜索策略
\include{tex/chapter5}   %Computational AI
\include{tex/chapter6}   %不确定性推理
\include{tex/chapter7}   %ML
\include{tex/chapter8}   %自然语言理解
\include{tex/chapter9}   %Distributed AI
\include{tex/chapter10}  %第十章  ES
\include{tex/chapter11}  %第十一章  CV
