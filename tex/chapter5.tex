...
%杨忠道， 著名数学家，专长代数拓扑和拓扑变换群。1946年，毕业于浙江大学数学系。1948年，任中央研究院数学研究所助理员。1949年，进美国杜伦大学学习，1954年获数学博士学位，同年去伊利诺大学攻读博士后。
%1954年，在美国普林斯顿高级研究院作访问研究。
%长期担任美国宾夕法尼亚大学数学教授，曾兼任数学系研究生部主任4年，数学系主任5年。
%1968年，当选为中央研究院院士（台湾）。

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{remark}
(一般拓扑学中的杨忠道定理)\,\,若集合$X$中每个单点集的导集是闭集, 则$X$的每个子集的导集也是闭集, $\bar{A} \subseteq A \cup A^{\prime}$.  
\end{remark}

引理1.  $\forall x \in\left(A \cup A^{\prime}\right)^{c}=A^{c} \cap\left(A^{\prime}\right)^{c}$
$x \in\left(A^{\prime}\right)^{c} \Rightarrow \exists$$x$的开邻域$U$, $(U-\{x\}) \cap A=\emptyset$
$x \in A^{c} \Rightarrow U \cap A=\emptyset \Rightarrow x \in(\bar{A})^{c}$
蕴含着 $\left(A \cup A^{\prime}\right)^{c} \subseteq(\bar{A})^{c}$, 这等价于$\bar{A} \subseteq A \cup A^{\prime}$

引理 2. $A^{\prime} \subseteq A \Rightarrow A$闭，证明 $A^{\prime} \subseteq A \Rightarrow A \cup A^{\prime}=A \Rightarrow \bar{A} \subseteq A \Rightarrow A$是闭的.

Theorem. $\forall x \in X,\{x\}^{\prime}$ is closed $\Rightarrow \forall A \subseteq X, A^{\prime}$ is closed

由引理 2 , 可以证明 $\left(A^{\prime}\right)^{\prime} \subseteq A^{\prime}$ $\forall x \in\left(A^{\prime}\right)^{\prime} \Rightarrow \forall o p e n n b h U$ of $x,(U-\{x\}) \cap A^{\prime} \neq \emptyset$
欲证 $\forall$open $n b h V$ of $x,(V-\{x\}) \cap A \neq \emptyset$, 等价于$x \in A^{\prime}$.

由于$\{x\}^{\prime}$ 闭且$V$ 开, $V \cap\left(\{x\}^{\prime}\right)^{c}$ 也是开的. 
显然有$x \in\left(\{x\}^{\prime}\right)^{c}$, 因此有$V \cap\left(\{x\}^{\prime}\right)^{c}$是$x$的开邻域, 即$\left[V \cap\left(\{x\}^{\prime}\right)^{c} \cap\{x\}^{c}\right] \cap A^{\prime} \neq \emptyset$
因为 $\{\bar{x}\} \subseteq\{x\} \cup(\{x\})^{\prime}, V \cap\{\bar{x}\}^{c} \cap A^{\prime} \supseteq\left[V \cap\left(\{x\}^{\prime}\right)^{c} \cap\{x\}^{c}\right] \cap A^{\prime} \neq \emptyset$
因此, 可以找到$y \in V \cap\{\bar{x}\}^{c} \cap A^{\prime}$
因为 $V \cap\{\bar{x}\}^{c}$ is an open nbh of $y, V \cap\{\bar{x}\}^{c} \cap\{y\}^{c} \cap A \neq \emptyset$
注意到 $\{x\}^{c} \supseteq\{\bar{x}\}^{c}$
因此 $(V-\{x\}) \cap A \supseteq V \cap\{\bar{x}\}^{c} \cap\{y\}^{c} \cap A \neq \emptyset$, 定理得证.
