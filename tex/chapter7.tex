...
AdaBoost后来衍生出一个庞大的算法家族, 统称Boosting, 是机器学习中“集成学习”的主流代表性技术。  \index{集成学习}
\end{example}
...
\label{CCNshuidao20191216181108}\vspace{-0.4cm}
\end{figure}
...
\label{CCNshuidao20191216181137}\vspace{-0.4cm}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsection{图卷积神经网络}
...
\label{GNNGAS20191216202234}\vspace{-0.4cm}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
