...
如果你用一个$N_2\times N_2$的过滤器卷积一个$N_1\times N_1$的图像, 填充数为$P$, 步幅为$S$, $3\times 3$的输出变为
...
\item 使用 GPU 可将网络训练时间从几天缩短到几小时. 可以在 MATLAB 中使用 GPU, 无需任何额外编程. 推荐 NVIDIA\textcopyright 3.0 计算能力的 GPU. 多个 GPU 能更加快地处理速度.
