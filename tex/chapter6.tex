...
\begin{align}
  ...
  \end{array}
\end{align}
则称$m$是$2^{\Omega}$上的概率分配函数, $m(A)$称为$A$的基本概率数. \index{基本概率数}
\end{example}
...
设有如下规则:
\begin{itemize}
\item $r_1$:  IF\,\,  $E_1$\,\,  AND\,\,  $E_2$\,\,  THEN\,\,  A={a1, a2}\,\,  \textup{CF}=\{0.3,  0.5\};
\item $r_2$:  IF\,\,  $E_3$\,\,  AND\,\,  (E4  OR  E5)\,\,  THEN\,\,  B={b1}  \textup{CF}=\{0.7\};
