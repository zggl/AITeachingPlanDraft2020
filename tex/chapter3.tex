...
\begin{figure}[H]
\begin{center}
    \begin{tikzpicture}[decision/.style={diamond, draw, fill=blue!20, text width=5.5cm, aspect=5,align=flush center, inner sep=0pt},font={\sf \small},scale=0.6]
        \def \smbwd{2cm}
        \def \smbwe{4cm}
        %定义流程图的具体形状
        ...
        \node (ToDB)[draw, process,align=center,right=0.8cm of QueryNewFact]{假设\\成立\\并放\\入DB};
        ...
        \node (NewAssu)[draw,process,align=center,xshift=0.7cm,right=1.6cm of AddNewtop] {还有\\新的\\假设吗?};
