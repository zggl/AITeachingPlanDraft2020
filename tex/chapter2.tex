...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
        \item  事实性知识: 也成陈述性知识, 用于描述事物的概念、定义和属性等; 或用于描述问题的状态、环境、条件等.
