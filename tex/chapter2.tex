...
\end{mydef}
\begin{itemize}
\item  认识: 包括对事物现象、本质、属性、状态、关系、联系和运动等的认识.
\item  经验: 包括解决问题的微观方法: 如步骤、操作、规则、过程和技巧等.
\item  宏观方法: 如战略、战术、计谋和策略等.
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\paragraph{代表性的知识定义}
\begin{itemize}
\item  (1) Feigenbaum: 知识是经过剪裁、塑造、解释、选择和转换了的信息.
...
\begin{itemize}
\item 一阶谓词逻辑表示的逻辑学基础: 命题和真值; 论域和谓词；连词和量词; 项与合式公式; 自由变元与约束变元.
\item 谓词逻辑表示方法.
\item 谓词逻辑表示的应用和特性.
\end{itemize}
%%%%%-------------------------------------%%%%%
...
\item 个体: 论域中的元素.
\item 谓词: 在谓词逻辑中命题是用形如$P(x_1,x_2,\cdots,x_n)$的谓词来表示的.
\item 谓词名: 是命题的谓语, 表示个体的性质、状态或个体之间的关系.
\item 个体: 是命题的主语, 表示独立存在的事物或概念.
\end{itemize}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{mydef}{$n$元谓词}{1}
...
\textbf{优点}: 简单明了, 且能求出所有解.

\textbf{缺点}: 执行效率较低, 原因是使用规则具有一定的盲目性.
...
\textbf{优点}: 不使用与问题无关的规则. 因此, 对那些目标明确的问题, 使用反向推理方式是一种最佳选择.
