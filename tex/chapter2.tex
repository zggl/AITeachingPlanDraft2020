...
\begin{center}
    ...
    \draw[->] (qLPV.east)->(UniSampling2)node[left,yshift=0.05cm,rotate=10,xshift=-1.05cm] {Can};
    \draw[->] (qLPV.east)->(UniSampling1)node[left,yshift=-0.05cm,rotate=-12,xshift=-1.05cm] {Can};
    \end{tikzpicture}
\end{center}
\vspace{-0.2cm}
\end{figure}
...
%%%%%-------------------------------------
\paragraph{语义关系的否定表示}
    分为基本语义关系的否定和一般语义关系的否定. 基本语义关系的否定的表示, 可通过在有向弧上直接标注该基本语义关系的否定的方法来解决.
%%%%%-------------------------------------
\begin{figure}[H]
\centering
