...
存放求解问题的各种当前信息: 问题的初始状态、输入的事实、中间结论及最终结论等.
...
\begin{figure}[H]
\centering
\includegraphics[width=0.35\textwidth]{eryuanguanxi2019112509.PNG}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.35\textwidth]{tuli2019112510.PNG}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{tuli20191125103.PNG}
...
\end{tikzpicture}
\caption{例\ref{Chap2exam278}的的语义网络}
\label{AI32fig105}
\end{center}
\end{figure}
